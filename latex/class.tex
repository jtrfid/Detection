...
% 由ch1.pptx生成pdf
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\include{ch2-part1} %概率论简单回顾
%\include{ch2backup} %概率论回顾全集备份
%\include{ch2-StochasticProcess} % ch2 随机过程
%\include{ch2-Example} % ch2习题，已整合至ch-part1和ch2-StochasticProcess中
%%%%%%%%%%%%%%%%%%%% ch1,ch2共5次课，第5次课后45分钟作业: 雷达回波信号, y=ax+b
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ch3
%\include{ch3}  % 部分公式
%\include{ch3-1} %统计检测概论，判决域, 贝叶斯准则(部分),第6次课
%\include{ch3-2} %贝叶斯准则(续)，例题1
%\include{ch3-3} %贝叶斯例题2,性能分析,例题3
%\include{ch3-3-ex4} %例题4, 随堂作业
%\include{ch3-4} %例题4讲解，最小平均错误概率，最大后验概率, 极小极大化准则(部分)。第9次课, 国庆节前最后一次课
%\include{ch3-5} %极小极大化准则(续)，奈曼皮尔逊准则，性能，特性
%\include{ch3-6} %M元检测，例8作业, 参量信号检测(不讲了)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ch4
%\include{ch4}  % 部分公式
%\include{ch4-1} %波形检测基本概念，正交级数展开，卡亨南---洛维展开，白噪声正交函数的任意性，参量随机过程正交级数展开
%\include{ch4-2} %高斯白噪声确知信号[简单二元波形检测]波形检测及性能分析
%\include{ch4-3} %简单二元波形检测---充分统计量法，作业推导判别式
%\include{ch4-4}  %一般二元波形检测---正交级数展开法(空45分钟)
\include{ch4-5}  %一般二元波形检测---充分统计量法，二元波形检测归纳
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
